...
> **Leidend plan:** `docs/masterplan-launch.md` (vervangt `masterplan-2026-08.md`). Dit handoff-doc blijft actief voor de nog-open G-rest-punten (B5-landing + B6-launchweek).
