...
const NL = {
  ...
  // Paneel — de zojuist gelogde trade nog bijwerken (F5)
  "panel.success.edit": "Nog aanpassen",
  "panel.updated.title": "Trade bijgewerkt",
  "panel.updated.text": "De aangepaste trade staat in je Beyen-journal.",
  "panel.editHint": "Je past de trade aan die je net logde — opslaan overschrijft 'm in Beyen.",
  "panel.submitUpdate": "Bewerking opslaan",
  "panel.submitUpdateBusy": "Opslaan…",

  // Paneel — open trades sluiten (F5)
  "close.sec.title": "Open trades op dit symbool",
  "close.loading": "Open trades zoeken…",
  "close.open": "Sluit",
  "close.cancel": "Annuleer",
  "close.openAria": "Sluit de trade van {when}",
  "close.modeLabel": "Hoe bepaal je het resultaat",
  "close.mode.exit": "Exit-prijs",
  "close.mode.manual": "Handmatig %",
  "close.exitLabel": "Exit-prijs",
  "close.exitPlaceholder": "prijs waar je uitstapte",
  "close.exitFromChart": "Overgenomen van de laatste candle op de chart.",
  "close.dateFollowsChart": "Sluitdatum volgt de chart.",
  "close.dateFollowsReplay": "Sluitdatum volgt de chart — die staat in replay, dus de replay-candle telt.",
  "close.manualLabel": "Resultaat %",
  "close.manualPlaceholder": "bv. 1.8 of -0.5",
  "close.dateLabel": "Sluitdatum",
  "close.noExitPath": "Deze trade mist richting, entry of stop — sluiten gaat met een handmatig resultaat.",
  "close.noBar": "De chart geeft geen laatste candle — vul het resultaat en de sluitdatum zelf in.",
  "close.previewEmpty": "Vul de exit-prijs in; Beyen leidt R, resultaat en uitkomst er zelf uit af.",
  "close.previewLine": "{r} R · {pct}%",
  "close.evalLabel": "Evaluatie",
  "close.eval.good": "Goede trade",
  "close.eval.emotional": "Emotionele fout",
  "close.eval.technical": "Technische fout",
  "close.maeLabel": "MAE %",
  "close.mfeLabel": "MFE %",
  "close.excursionHint": "Hoe ver liep de trade tegen je in (MAE) en met je mee (MFE), in %.",
  "close.submit": "Sluit trade",
  "close.submitBusy": "Sluiten…",
  "close.success.title": "Trade gesloten: {outcome} · {pct}% · {date}",
  "close.success.open": "Bekijk in Beyen",

  // Paneel — sluiten, wat er nog mist
  "close.v.noExitPath": "Deze trade mist richting, entry of stop — kies \"Handmatig %\".",
  "close.v.noBar": "De chart geeft geen laatste candle — kies \"Handmatig %\".",
  "close.v.needExit": "Vul de exit-prijs in.",
  "close.v.exitPositive": "De exit-prijs moet groter dan 0 zijn.",
  "close.v.needResult": "Vul het resultaat in % in.",
  "close.v.needDate": "Vul de sluitdatum in.",
  "close.v.closeBeforeOpen": "De sluitdatum ligt vóór de opening ({date}).",
  "close.v.excursion": "MAE en MFE zijn afstanden in %: een getal van 0 of meer.",

  // Foutcopy van het sluitpad
  "close.err.generic": "Sluiten is niet gelukt.",
  "close.err.notFound": "Deze trade staat niet meer open in Beyen — hij is daar net gesloten of verwijderd.",
  "close.err.missedNotSelectable":
    "\"Missed trade\" hoort bij een setup die je niet nam — een trade die je sluit kan dat nooit zijn.",
  "close.err.invalidEvaluation": "Die evaluatie kent Beyen niet.",
  "close.err.exitInvalid": "De exit-prijs is onbruikbaar.",
  "close.err.resultInvalid": "Het resultaat is geen bruikbaar getal.",
  "close.err.invalidExcursion": "MAE en MFE mogen niet negatief zijn.",
  "close.err.noCloseTime": "Zonder sluitdatum kan de trade niet dicht — vul er één in.",
  "close.err.closeBeforeOpen": "De sluitdatum ligt vóór de dag waarop de trade openging.",
  ...
  "err.notFound": "Deze trade is intussen in Beyen aangepast of verwijderd — bijwerken vanaf de chart kan niet meer.",
...
const EN: Record<MessageKey, string> = {
  ...
  // Panel — editing the trade you just logged (F5)
  "panel.success.edit": "Still edit it",
  "panel.updated.title": "Trade updated",
  "panel.updated.text": "The edited trade is in your Beyen journal.",
  "panel.editHint": "You're editing the trade you just logged — saving overwrites it in Beyen.",
  "panel.submitUpdate": "Save changes",
  "panel.submitUpdateBusy": "Saving…",

  // Panel — closing open trades (F5)
  "close.sec.title": "Open trades on this symbol",
  "close.loading": "Looking for open trades…",
  "close.open": "Close",
  "close.cancel": "Cancel",
  "close.openAria": "Close the trade from {when}",
  "close.modeLabel": "How you set the result",
  "close.mode.exit": "Exit price",
  "close.mode.manual": "Manual %",
  "close.exitLabel": "Exit price",
  "close.exitPlaceholder": "price you got out at",
  "close.exitFromChart": "Taken from the last candle on the chart.",
  "close.dateFollowsChart": "The close date follows the chart.",
  "close.dateFollowsReplay": "The close date follows the chart — it's in replay, so the replay candle counts.",
  "close.manualLabel": "Result %",
  "close.manualPlaceholder": "e.g. 1.8 or -0.5",
  "close.dateLabel": "Close date",
  "close.noExitPath": "This trade has no direction, entry or stop — close it with a manual result.",
  "close.noBar": "The chart gives no last candle — fill in the result and the close date yourself.",
  "close.previewEmpty": "Fill in the exit price; Beyen derives R, result and outcome from it.",
  "close.previewLine": "{r} R · {pct}%",
  "close.evalLabel": "Evaluation",
  "close.eval.good": "Good trade",
  "close.eval.emotional": "Emotional error",
  "close.eval.technical": "Technical error",
  "close.maeLabel": "MAE %",
  "close.mfeLabel": "MFE %",
  "close.excursionHint": "How far the trade ran against you (MAE) and with you (MFE), in %.",
  "close.submit": "Close trade",
  "close.submitBusy": "Closing…",
  "close.success.title": "Trade closed: {outcome} · {pct}% · {date}",
  "close.success.open": "View in Beyen",

  // Panel — closing, what's still missing
  "close.v.noExitPath": "This trade has no direction, entry or stop — pick \"Manual %\".",
  "close.v.noBar": "The chart gives no last candle — pick \"Manual %\".",
  "close.v.needExit": "Fill in the exit price.",
  "close.v.exitPositive": "The exit price must be greater than 0.",
  "close.v.needResult": "Fill in the result in %.",
  "close.v.needDate": "Fill in the close date.",
  "close.v.closeBeforeOpen": "The close date lies before the opening ({date}).",
  "close.v.excursion": "MAE and MFE are distances in %: a number of 0 or more.",

  // Error copy of the close path
  "close.err.generic": "Closing failed.",
  "close.err.notFound": "This trade is no longer open in Beyen — it was just closed or deleted there.",
  "close.err.missedNotSelectable":
    "\"Missed trade\" belongs to a setup you didn't take — a trade you're closing can never be one.",
  "close.err.invalidEvaluation": "Beyen doesn't know that evaluation.",
  "close.err.exitInvalid": "The exit price is unusable.",
  "close.err.resultInvalid": "The result isn't a usable number.",
  "close.err.invalidExcursion": "MAE and MFE may not be negative.",
  "close.err.noCloseTime": "Without a close date the trade can't be closed — fill one in.",
  "close.err.closeBeforeOpen": "The close date lies before the day the trade was opened.",
  ...
  "err.notFound": "This trade was edited or deleted in Beyen in the meantime — updating it from the chart is no longer possible.",
