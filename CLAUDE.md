...
- Migratienummers: nooit hergebruiken; elke migratie werkt `supabase/schema.sql` mee bij. **0059** = WPM fase-retirement (staat klaar op branch, owner draait 'm). Eerstvolgend vrij nummer = **0060**.
