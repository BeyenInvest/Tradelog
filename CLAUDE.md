...
- **Uitzondering (owner-besluit 2026-09-15/16): de TradingView-extensie.** Leidend plan = `docs/plan-tv-extensie-engines.md` (blokken S0/F1–F5); S0-spike ✅ alle 4 punten GO (`docs/spike-tv-extensie.md`), F1a (`api/extension-link.ts`) gebouwd. Extensiecode leeft in `extension/`; alles blijft achter `betaFeatures`; model-per-fase geldt (Fable: auth/adapter/migraties/security, Opus: UI).
