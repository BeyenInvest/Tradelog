 ...
 * never shows again.
 *
 * Gated on betaFeatures (the journal builder/preset-picker it drives is beta
 * until the public launch) AND onboarded_at being null. Mounted once as an
 * overlay in the router's protected layout, above the AppShell, so it is
